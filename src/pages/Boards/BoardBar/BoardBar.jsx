      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
        ...
        >
          <Tooltip title="Khang">
            <Avatar
              alt="Khang"
              src="https://img.freepik.com/premium-vector/round-icon-young-man-avatar-face-flat-style_768258-2077.jpg"
            />
          </Tooltip>
          <Tooltip title="Khang">
            <Avatar
          ...
          <Tooltip title="Khang">
            <Avatar
              alt="Khang"
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQY3qp4vyt8ko3KsV7B5nMDnOpVMjufZQxBMw&s"
            />
          </Tooltip>
          <Tooltip title="Khang">
            <Avatar
          ...
          <Tooltip title="Khang">
            <Avatar
              alt="Khang"
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ7pc0jhWSk63wc7aDE0uoUTdEWC1xcDVAd2Q&s"
            />
          </Tooltip>
          <Tooltip title="Khang">
            <Avatar
