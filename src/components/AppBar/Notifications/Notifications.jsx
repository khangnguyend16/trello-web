...
import { fetchInvitationsAPI, updateBoardInvitationAPI, selectCurrentNotifications, addNotification } from "~/redux/notifications/notificationsSlice";
...
function Notifications() {
  ...
  // Biến state kiểm tra xem có thông báo nào mới hay không
  ...
  // Fetch danh sách invitations
  const dispatch = useDispatch();
  useEffect(() => {
    dispatch(fetchInvitationsAPI());

    // Tạo 1 fucntion xử lý khi nhận được sự kiện real-time
    // https://socket.io/how-to/use-with-react
    const onReceiveNewInvitation = (invitation) => {
      // Nếu thằng user đang đăng nhập hiện tại mà chung ta lưu trong redux chính là thằng invitee trong bản ghi invitation
