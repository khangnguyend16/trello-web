  ...
  return (
    <Box sx={{ mt: 2 }}>
      ...
      <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 2 }}>
        <Avatar sx={{ width: 36, height: 36, cursor: "pointer" }} alt="khangnguyen" src={currentUser?.avatar} />
      ...
      {cardComments.map((comment, index) => (
        <Box sx={{ display: "flex", gap: 1, width: "100%", mb: 1.5 }} key={index}>
          <Tooltip title="khangnguyen">
            <Avatar sx={{ width: 36, height: 36, cursor: "pointer" }} alt="khangnguyen" src={comment?.userAvatar} />
          </Tooltip>
