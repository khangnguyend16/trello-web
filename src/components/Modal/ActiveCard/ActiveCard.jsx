...
function ActiveCard() {
  ...
  // Function gọi API dùng chung cho các trường hợp update card title, description, cover...
  ...
  // Dùng async await để component con CardActivitySection chờ và nếu thành công thì mới clear thẻ input commnent
